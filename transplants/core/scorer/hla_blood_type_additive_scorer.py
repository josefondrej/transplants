...
from transplants.core.patient.medical_data.hla_system.antigen_definitions import A_antigens, B_antigens, DRB1_antigens
...
class HLABloodTypeAdditiveScorer(AdditiveScorerBase):
    ...
    def __init__(
        ...
        super().__init__(forbidden_transplants=forbidden_transplants, min_required_base_score=min_required_base_score)

    def score_transplant_base(self, transplant: Transplant) -> float:
        donor, recipient = transplant.donor, transplant.recipient
